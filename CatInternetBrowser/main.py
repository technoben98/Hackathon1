...
class Browser(QMainWindow):
    def __init__(self):
        ...
        back_btn = QAction(QIcon(os.path.join("images", "cat-facing-left.png")), "Back", self)
        back_btn.setStatusTip("Back on prev page")
        back_btn.triggered.connect(lambda: self.tab_widget.currentWidget().back())
        qtoolbar.addAction(back_btn)

        next_btn = QAction(QIcon(os.path.join("images", "cat-facing-right.png")), "Next", self)
        ...
        reload_btn = QAction(QIcon(os.path.join("images", "refresh.png")), "Refresh", self)
        ...
        home_btn = QAction(QIcon(os.path.join("images", "pet.png")), "Home", self)
        ...
        new_tab_btn = QAction(QIcon(os.path.join("images", "pet-care.png")), "New Tab", self)
        new_tab_btn.setStatusTip("Open new tab")
        new_tab_btn.triggered.connect(lambda: self.add_new_tab())
        qtoolbar.addAction(new_tab_btn)

        info_btn = QAction(QIcon(os.path.join("images", "info.png")), "Info", self)
        ...
        self.add_new_tab(QUrl("https://google.com"), "Home Page")
    ...
    def add_new_tab(self, qurl=QUrl("https://google.com"), label="blank"):
        ...
        browser.loadFinished.connect(lambda _, i=tab, browser=browser: self.tab_widget.setTabText(tab, browser.page().title()))
    ...
    def update_title(self, browser):
        ...
        self.setWindowTitle(f"{title} - Cats Browser")

    def info(self):
        QMessageBox.about(self, "Cats Browser","Created by Dmitriy Benevelskyi")
...
if __name__ == '__main__':
    ...
    app.setOrganizationName("Cat Team")
    window = Browser()
